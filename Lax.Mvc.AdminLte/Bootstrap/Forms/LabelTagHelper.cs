...
namespace Lax.Mvc.AdminLte.Bootstrap.Forms {
    ...
    public class LabelTagHelper : BootstrapTagHelper {
        ...
        public override void Init(TagHelperContext context) {
            ...
            SrOnly ??= FormContext?.LabelsSrOnly;
        }
        ...
        public static IHtmlContent GenerateLabel(string content, string controlId) =>
            GenerateLabel(content, controlId, null);
        ...
        public static IHtmlContent GenerateLabel(string content) => GenerateLabel(content, (FormTagHelper) null);

        public static IHtmlContent GenerateLabel(string content, FormTagHelper formContext) =>
            GenerateLabel(content, null, formContext);
