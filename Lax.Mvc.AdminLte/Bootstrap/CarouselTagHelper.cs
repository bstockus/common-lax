    ...
    public class CarouselTagHelper : BootstrapTagHelper {
        ...
        protected override async Task BootstrapProcessAsync(TagHelperContext context, TagHelperOutput output) {
            ...
            output.Content.Wrap(new TagBuilder("div") {
                Attributes = {{"class", "carousel-inner"}, {"role", "listbox"}}
            });
            output.PostContent.AppendHtml(
                $"<a class=\"left carousel-control\" href=\"#{Id}\" role=\"button\" data-slide=\"prev\">" +
                $"<span class=\"glyphicon glyphicon-chevron-left\" aria-hidden=\"true\"></span><span class=\"sr-only\">{Ressources.Previous}</span></a>" +
                $"<a class=\"right carousel-control\" href=\"#{Id}\" role=\"button\" data-slide=\"next\">" +
                $"<span class=\"glyphicon glyphicon-chevron-right\" aria-hidden=\"true\"></span><span class=\"sr-only\">{Ressources.Next}</span></a>");
        }
