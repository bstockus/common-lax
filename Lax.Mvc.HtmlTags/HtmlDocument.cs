...
namespace Lax.Mvc.HtmlTags {
    ...
    public class HtmlDocument {
        ...
        private static void OpenFile(string fileName) => Process.Start(fileName);
        ...
        private string Substitute(string value) =>
            _alterations.Aggregate(value, (current, alteration) => alteration(current));
        ...
        public HtmlTag ReferenceScriptFile(string scriptType, string path) =>
            Head.Add("script").Attr("type", scriptType).Attr("src", path);
