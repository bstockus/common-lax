...
namespace Lax.Mvc.HtmlTags.Reflection {
    ...
    public class SingleProperty : IAccessor {
        ...
        public SingleProperty(PropertyInfo property) => InnerProperty = property;
        ...
        public bool Equals(SingleProperty other) {
            ...
            return ReferenceEquals(this, other) || InnerProperty.PropertyMatches(other.InnerProperty);
        }
        ...
        public override bool Equals(object obj) {
            ...
            return obj.GetType() == typeof(SingleProperty) && Equals((SingleProperty) obj);
        }
