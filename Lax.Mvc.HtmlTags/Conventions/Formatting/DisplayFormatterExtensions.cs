...
namespace Lax.Mvc.HtmlTags.Conventions.Formatting {
    ...
    public static class DisplayFormatterExtensions {
        ...
        public static string FormatValue(this IDisplayFormatter formatter, Type modelType, IAccessor accessor,
        ...
        public static string
            GetDisplayForProperty(this IDisplayFormatter formatter, IAccessor accessor, object target) =>
            formatter.GetDisplay(accessor, accessor.GetValue(target));
        ...
        /// <param name="value">The data to format</param>
        public static string FormatValue(this IDisplayFormatter formatter, Type modelType, IAccessor property,
        ...
        public static string FormatProperty(this IDisplayFormatter formatter, Type modelType, IAccessor property,
            object entity) {
